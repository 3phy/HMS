                    ...
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            <form method="GET" class="form-inline mb-3">
                                ...
                                <a href="his_admin_view_patients.php" class="btn btn-secondary btn-sm ml-2">Reset</a>
                            </form>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <!--<a href="his_admin_view_single_patient.php?pat_id=<?php echo $row->pat_id;?>&&pat_number=<?php echo $row->pat_number;?>" class="badge badge-success"><i class="mdi mdi-email"></i> Email</a>-->
                                                </td>
                                            </tr>
                                        </tbody>
                                    <?php 
