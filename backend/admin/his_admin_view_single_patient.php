                        ...
                        <div class="col-lg-4 col-xl-4">
                            <div class="card-box text-center">
                                ...
                                <div class="text-left mt-3">
                                    ...
                                    <p class="text-muted mb-2 font-13"><strong>Municipality :</strong> <span class="ml-2"><?php echo $row->pat_mun;?></span></p>
                        ...
                        <div class="col-lg-4 col-xl-8">
                            <div class="card-box text-center">
                                <div class="text-left mt-3">
                                    ...
                                    <!-- Send PDF Button -->
<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#sendEmailModal<?php echo $pat_id; ?>">
  Send PDF to Email
</button>
<!-- Modal: Send PDF to Email -->
<div class="modal fade" id="sendEmailModal<?php echo $pat_id; ?>" tabindex="-1" role="dialog" aria-labelledby="sendEmailLabel<?php echo $pat_id; ?>" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="his_admin_send_patient_pdf.php" method="POST">
      <input type="hidden" name="pat_id" value="<?php echo $pat_id; ?>">
      <input type="hidden" name="pat_email" value="<?php echo htmlspecialchars($row->pat_email); ?>">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="sendEmailLabel<?php echo $pat_id; ?>">Send Patient PDF to Email</h5>
          <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
        </div>
        <div class="modal-body">
          <p>Are you sure you want to send the patient's full profile and consultation history as a PDF to:</p>
          <p><strong><?php echo htmlspecialchars($row->pat_email); ?></strong></p>
        </div>
        <div class="modal-footer">
          <button type="submit" name="send_pdf" class="btn btn-primary">Send Email</button>
