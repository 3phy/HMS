                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li>
                                        <a href="his_admin_inpatient_records.php">Active/Inactive Records</a>
                                    </li>
                                    <li>
                                        <a href="his_admin_outpatient_records.php">Discharge Records</a>
                                    </li>   
                                    <li>
                                        <a href="his_admin_logs.php">Logs and Charts</a>
