...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['change_pass'])) {
    ...
    if ($new_pass !== $confirm_pass) {
        ...
        // Hash the password like others
        $hashed_pass = sha1(md5($new_pass));
        // Update password in the database
        $stmt = $mysqli->prepare("UPDATE his_docs SET doc_pwd=? WHERE doc_email=?");
        ...
        if ($stmt->execute()) {
            ...
            header("refresh:2;url=his_doc_changepass.php");
        } else {
...
<head>
    <meta charset="utf-8" />
    <title>Reset Doctor Password - Hospital Management System</title>
                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card bg-pattern">
                        <div class="card-body p-4">
                            <div class="text-center w-75 m-auto">
                                ...
                                <p class="text-muted mb-4 mt-3">Please enter your new password below to reset your doctor account.</p>
                            </div>
                            <form method="post">
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p class="text-white-50">Return to <a href="index.php" class="text-white ml-1"><b>Doctors Login</b></a></p>
                        </div>
                    </div>
                </div>
            </div>
