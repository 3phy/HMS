...
if (isset($_POST['confirm_delete'])) {
    ...
    $stmt = $mysqli->prepare("SELECT doc_pwd FROM his_docs WHERE doc_id=?");
    ...
    if ($db_password === sha1(md5($doc_password))) {
...
if (isset($_POST['confirm_update'])) {
    ...
    if ($db_password === sha1(md5($doc_password))) {
        header("location: his_doc_update_single_patient.php?pat_id=" . $update_id);
        exit;
    } else {
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <!-- Update -->
                                                        <a href="#" class="badge badge-primary" data-toggle="modal" data-target="#updateModal<?php echo $row->pat_id; ?>"><i class="mdi mdi-check-box-outline"></i> Update</a>
                                                        <div class="modal fade" id="updateModal<?php echo $row->pat_id; ?>" tabindex="-1">
                                                            <div class="modal-dialog">
                                                                <form method="post" action="his_doc_manage_patient.php" autocomplete="off">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <input type="password" name="doc_password" class="form-control" placeholder="Password" required>
                                                                            <p class="text-warning mt-2">Update this patient record?</p>
                                                                        </div>
                                                        ...
                                                        <!-- Delete -->
                                                        <a href="#" class="badge badge-danger" data-toggle="modal" data-target="#deleteModal<?php echo $row->pat_id; ?>"><i class="mdi mdi-trash-can-outline"></i> Delete</a>
                                                        <div class="modal fade" id="deleteModal<?php echo $row->pat_id; ?>" tabindex="-1">
                                                            <div class="modal-dialog">
                                                                <form method="post" action="his_doc_manage_patient.php" autocomplete="off">
                                                                    <input type="hidden" name="delete_id" value="<?php echo $row->pat_id; ?>">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <input type="password" name="doc_password" class="form-control" placeholder="Password" required>
                                                                            <p class="text-danger mt-2">Are you sure you want to delete this patient record?</p>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
